...
describe RSpec::Core::Formatters::JunitFormatter do
  let(:output) { StringIO.new }
  let(:formatter) { RSpec::Core::Formatters::JunitFormatter.new(output) }
      ...
      it 'outputs the name and location' do
        ...
        output.string.should include(
          'Shared Example Group: "foo bar" called from ' +
            "./spec/rspec/core/formatters/junit_formatter_spec.rb:#{line}"
        )
      end
